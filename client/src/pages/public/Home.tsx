...
export default function App() {
  return (
    <div>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-7xl px-6 py-32">
          <div className="grid items-center gap-24 lg:grid-cols-2">
            <div className="space-y-8">
              ...
              >
                We provide the structure and guidance to document everything
                from funeral preferences to digital asset access, safely stored
                until needed.
              </motion.p>
        ...
        <section className="mx-auto max-w-4xl space-y-12 px-6 py-32 text-center">
          ...
          >
            ...
            nominees can ever view your plan. Our systems are audited annually
            for the highest standards of data protection.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
      ...
      {/* Footer */}
      <footer className="border-t border-border/40 bg-muted/50 px-6 py-24">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-12 md:grid-cols-4">
          <div className="col-span-2 space-y-6 md:col-span-1">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
              © 2024 LegacyCare. A Sanctuary for End-of-Life Planning.
            </p>
          </div>
